...
local Window = Fluent:CreateWindow({
    Title = "triet is fat HUB",
    SubTitle = "2second_2322",
    TabWidth = 160,
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "TP đến player trong 1 sea", Description = "",Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "ngắm vào người chơi",Description = "", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = " Click đánh player",Description = "", Default = false })
...
local ToggleShowFov = Tabs.Player:AddToggle("ToggleShowFov", {Title = "hiển thị kích cỡ màn hình",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Auto nhắm vào bằng chiêu",Description = "", Default = false })
...
local ToggleNoClip = Tabs.Player:AddToggle("ToggleNoClip", {Title = "Auto No bị quay clip",Description = "", Default = false })
...
local ToggleWalkonWater = Tabs.Player:AddToggle("ToggleWalkonWater", {Title = "Walk đi trên nước",Description = "", Default = true })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Auto chạy nhanh",Description = "", Default = true })
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "Auto bật PVP với lv 20 trở lên", Description = "",Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Auto ngắm fruit",Description = "", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Auto lưu trữ trái",Description = "", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Auto ramdom fruit",Description = "", Default = false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "dịch chuyển tức thời đến fruit spam",Description = "có thể bị gặp lỗi khi sử dụng", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "bay đến fruit spam",Description = "đang fix", Default = false })
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "tìm player",Description = "", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "tìm Fruit",Description = "", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "tìm đảo",Description = "", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "tìm hoa",Description = "", Default = false })
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title = "Auto mua chip raid", Description = "",Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Auto kill mấy vật xung quanh",Description = "", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Auto đi đến đảo tiếp theo",Description = "", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto thức tỉnh trái",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "lấy fruit thấp",Description = "", Default = false })
...
if Second_Sea then
Tabs.Raid:AddButton({
    Title = "di chuyển đến phòng thức tỉnh trái",
    Description = "",
    Callback = function()
...
local Mastery = Tabs.Raid:AddSection("Auto chia law thành 1/2")


local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Auto chia law thành 1/2",Description = "", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "tự dộng trail tộc human và ghoul",Description = "", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "tự động trail tất cả tộc",Description = "", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "tự động train tộc",Description = "", Default = false })
...
Tabs.Race:AddParagraph({
    Title = "tộc",
    Content = "tự động làm nhiệm vụ tộc"
})



local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "tự động farm tộc nhiệm vụ", Default = false })
ToggleAutoAcientQuest:OnChanged(function(Value)
    AutoFarmAcient = Value
end)
Options.ToggleAutoAcientQuest:SetValue(false)
...
local ToggleAutoSoulGuitar = Tabs.Main:AddToggle("ToggleAutoSoulGuitar", {Title = "lấy soul guitar",Description = "đang fix", Default = false })
...
local args = {[1] = "CyborgTrainer", [2] = "Buy"}
    ...
    Tabs.Shop:AddButton({
        Title = "mua tộc ác quỷ ff",
        Description = "yêu cầu: 250 vật chất 250",
        Callback = function()            
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "tự động join lại", Description = "",Default = true })
...
Tabs.profile:AddParagraph({
        Title = "chủ server",
        Content = "by 2second_2322"
    })
  
Tabs.profile:AddParagraph({
        Title = "link Discord minhnguyen2123",
        Content = "https://discord.com/invite/PUX8JunKAS"
    })      
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop
